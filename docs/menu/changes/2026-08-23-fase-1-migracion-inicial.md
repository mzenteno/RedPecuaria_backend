...
Se creó la tabla `menus` (key único, label, icon, path, parent_id auto-referenciado, order,
is_active, created_at) vía la migración `src/migrations/1787534864457-InitialSchema.ts`,
